 ...
 * @since 0.0.1
 */
class WTGTASKSMANAGER_Finishedtasks_View extends WTGTASKSMANAGER_View {
    ...
    protected $view_name = 'finishedtasks';
    ...
    * @version 1.0
    */
    public function postbox_finished_example( $data, $box ) {    
...
* @version 1.0
*/
class WTGTASKSMANAGER_WPTable_FinishedTasks extends WP_List_Table {
    ...
    function column_default( $item, $column_name ){   
        ...
        switch( $column_name){
            ...
            case 'post_title':
                ...
                break;    
            case 'finishtime':
                return date( 'Y-m-d H:i:s', get_post_meta( $item->ID, 'wtgfinishtime', true ) );
                break;            
            case 'duration':
                $finishtime = get_post_meta( $item->ID, 'wtgfinishtime', true );
                return human_time_diff( strtotime( $item->post_date ), $finishtime );
                break;  
            case 'taskpriority':
    ...
    **************************************************************************/
    ...
    function get_columns() {
        $columns = array(
            ...
            'finishtime'     => __( 'Finish Time', 'wtgtasksmanager' ),
            'duration' => __( 'Duration', 'wtgtasksmanager' ),
    ...
    function column_ID( $item ) {
        $actions = array(                      
            ...
            'continuetask'    => $this->UI->linkaction( 'wtgtasksmanager_finishedtasks', 'continuetask', __( 'Continue this task.', 'wtgtasksmanager' ), __( 'Continue', 'wtgtasksmanager' ), $values = '&task=' . $item->ID ),
            'closetask'    => $this->UI->linkaction( 'wtgtasksmanager_finishedtasks', 'closetask', __( 'Close this task.', 'wtgtasksmanager' ), __( 'Close', 'wtgtasksmanager' ), $values = '&task=' . $item->ID ),
        );
