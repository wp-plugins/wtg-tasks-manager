...
/**
 * Closed Tasks table view.
 * 
 * Tasks are closed after project manager or team or community (depending on requirement) accepts the finished work
 * submitted by developer who finished the task.
 * 
 * @package WTG Tasks Manager
 * @subpackage Views
 * @author Ryan Bayne
 * @since 0.0.1
 */
class WTGTASKSMANAGER_Closedtasks_View extends WTGTASKSMANAGER_View {
    ...
    protected $view_name = 'closedtasks';
    ...
    */
    public function datatables( $data, $box ) {    
        $WPTableObject = new WTGTASKSMANAGER_WPTable_ClosedTasks();
...
/**
* Table of closed tasks. Closed tasks usually indicate accepted work by either a team or community.
* (tasks are changed to Finished when developer submits/completes work, then they are closed)
* 
* @author Ryan R. Bayne
* @package WTG Tasks Manager
* @since 0.0.1
* @version 1.0
*/
class WTGTASKSMANAGER_WPTable_ClosedTasks extends WP_List_Table {
    ...
    function column_default( $item, $column_name ){   
        ...
        switch( $column_name){
            ...
            case 'post_title':
                ...
                break;       
            case 'wtgtaskclosedby':

                $user_id = get_post_meta( $item->ID, 'wtgtaskclosedby', true );
    ...
    **************************************************************************/
    ...
    function get_columns() {
        $columns = array(
            ...
            'wtgtaskclosedby' => __( 'Closed By', 'wtgtasksmanager' )
        );
