 ...
 * @since 0.0.1
 */
class WTGTASKSMANAGER_Milestones_View extends WTGTASKSMANAGER_View {
    ...
    protected $view_name = 'milestones';
    ...
    * @version 1.0
    */
    public function postbox_milestones_wysiwygeditor( $data, $box ) {    
