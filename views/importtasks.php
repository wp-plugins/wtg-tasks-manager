 ...
 * @since 0.0.1
 */
class WTGTASKSMANAGER_Importtasks_View extends WTGTASKSMANAGER_View {
    ...
    protected $view_name = 'importtasks';
    ...
    */
    public function meta_box_array() {
        ...
        return $this->meta_boxes_array = array(
            ...
            array( $this->view_name . '-csvimporttasksmultipleprojects', __( 'CSV Import Multiple Projects', 'wtgtasksmanager' ), array( $this, 'parent' ), 'normal','default',array( 'formid' => 'csvimporttasksmultipleprojects' ), true, 'activate_plugins' ),
        );    
    }
    ...
    * @version 1.0
    */
    public function postbox_importtasks_csvimporttasksmultipleprojects( $data, $box ) {    
        $this->UI->postbox_content_header( $box['title'], $box['args']['formid'], __( 'Import a .csv file that contains the "Project" column and create tasks for multiple projects. Please ensure project names match exactly.', 'wtgtasksmanager' ), false );        
        $this->Forms->form_start( $box['args']['formid'], $box['args']['formid'], $box['title'], true );
        ?>        

            <table class="form-table">
            <?php        
            $this->Forms->input( $box['args']['formid'], 'file', 'taskscsv', 'taskscsv', __( 'Select CSV File', 'wtgtasksmanager' ), '', true, '', array(), array() );
            ?>
            </table>
