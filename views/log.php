 ...
 * @since 0.0.1
 */
class WTGTASKSMANAGER_Log_View extends WTGTASKSMANAGER_View {
    ...
    */
    public function meta_box_array() {
        ...
        return $this->meta_boxes_array = array(
            ...
            array( $this->view_name . '-deleteentirelog', __( 'Delete Entire Log', 'wtgtasksmanager' ), array( $this, 'parent' ), 'normal','default',array( 'formid' => 'deleteentirelog' ), true, 'activate_plugins' ),
        );    
    }
    ...
    function column_default( $item, $column_name ){   
        ...
        switch( $column_name){
            ...
            case 'wtgtaskcancelledby':
                return $item->wtgtaskcancelledby;// userid 
                break;   
