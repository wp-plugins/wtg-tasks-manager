    ...
    public function postbox_createtasks_advanced( $data, $box ) {    
        ...
        ?>  
            <div id="poststuff">
                ...
                $this->Forms->input(  $box['args']['formid'], 'menu', 'projectid', 'projectid', __( 'Project', 'wtgtasksmanager' ), '', true, '', array( 'itemsarray' => $projects_array ) );    
                $this->Forms->input(  $box['args']['formid'], 'menu', 'priority', 'priority', __( 'Priority', 'wtgtasksmanager' ), '', true, '', array( 'itemsarray' => array( 1 => '1 - Urgent', 2 => '2 - High', 3 => '3 - Important', 4 => '4 - Low', 5 => '5 - Optional' ) ) );    
