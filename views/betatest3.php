 ...
 * @since 0.0.1
 */
class WTGTASKSMANAGER_Betatest3_View extends WTGTASKSMANAGER_View {
    ...
    */
    public function meta_box_array() {
        ...
        return $this->meta_boxes_array = array(
            ...
            array( 'betatest3-currenttesting', __( 'Test Introduction', 'wtgtasksmanager' ), array( $this, 'parent' ), 'normal', 'default', array( 'formid' => 'currenttesting' ), true, 'activate_plugins' ),
            array( $this->view_name . '-t1', __( 'WP Roles Array', 'wtgtasksmanager' ), array( $this, 'parent' ), 'normal','default',array( 'formid' => 't1' ), true, 'activate_plugins' ),
            array( $this->view_name . '-t2', __( 'Box Array: add_meta_box()', 'wtgtasksmanager' ), array( $this, 'parent' ), 'normal','default',array( 'formid' => 't2' ), true, 'activate_plugins' ),
            array( $this->view_name . '-t3', __( 'Invalid Entry: Text Field', 'wtgtasksmanager' ), array( $this, 'parent' ), 'normal','default',array( 'formid' => 't3' ), true, 'activate_plugins' ),
    ...
    */
    public function postbox_betatest3_currenttesting( $data, $box ) {     
        ...
        <p>Supporting Developer: Leslie Legrande</p>
    ...
    */
    public function postbox_betatest3_t1( $data, $box ) {    
        $this->UI->postbox_content_header( $box['title'], $box['args']['formid'], __( 'Roles testing.', 'wtgtasksmanager' ), false );        
    ...
    */
    public function postbox_betatest3_t3( $data, $box ) {   
        $this->UI->postbox_content_header( $box['title'], $box['args']['formid'], __( 'Invalid Text Field Entry', 'wtgtasksmanager' ), false );        
        $this->Forms->form_start( $box['args']['formid'], $box['title']);                                 
        ?>  
