...
class WTGTASKSMANAGER_PHP {  
    ...
    */
    ...
    /**
    * Uses either strtotime or mktime.
    * 
    ...
    */
    public function arrayinfo_set( $array, $line, $function, $file ){
        ...
        $array['arrayinfo']['date'] = WTGTASKSMANAGER::datewp();
        return $array;   
    }  
    ...
    * 2. Faster than wtgtasksmanager_count_extension_in_directory() because it returns sooner, important for directory with a lot of files
    * 
    * @returns boolean
    */
    ...
    */
    public function type( $value ){
        ...
        // is email address
        if( WTGTASKSMANAGER::is_valid_emailaddress( $value ) ){
            return 'email';
        }                  
    ...
    */
    public function months_time_range( $month, $year, $return = 'array', $format = 'time' ){
        ...
        if( $format == 'date' )
        {
            $array['start'] = WTGTASKSMANAGER::datewp(0, $array['start'] );
        }
        ...
        if( $format == 'date' )
        {    
            $array['end'] = WTGTASKSMANAGER::datewp(0, $array['end'] );   
        }
