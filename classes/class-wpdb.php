...
class WTGTASKSMANAGER_DB {     
    ...
    */
    public function options_beginning_with( $prependvalue){    
        ...
        // loop through each option record and check their name value for wtgtasksmanager_ at the beginning
    ...
    */
     ...
     * 2. Another approach is using wtgtasksmanager_WP_SQL_get_tables() and checking the array for the table, this is error free
     * 
     * @author Ryan R. Bayne
     * @package WTG Tasks Manager
     * @since 7.0.0
