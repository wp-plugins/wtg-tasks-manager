/**
 * JavaScript code for all WTG Tasks Manager admin screens, it makes postboxes work
 *
 * @package WTG Tasks Manager
 * @subpackage Views JavaScript
 * @author Tobias Bäthge (author of WTGTASKSMANAGER plugin)
 * @since 0.0.1
 */
...
jQuery( document ).ready( function( $ ) {
	 ...
	 * For WTGTASKSMANAGER, pagenow has the form "tablepress_{$action}"
	 *
	 * @since 0.0.1
	 */
